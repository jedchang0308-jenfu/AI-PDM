...
import { approveSubmissionObsoleteReviewAsync, getSubmissionLifecycleRequestByIdAsync } from "@/lib/submission-lifecycle-async";
...
export async function POST(request: Request, { params }: { params: Promise<{ requestId: string }> }) {
  ...
  try {
    const result = await approveSubmissionObsoleteReviewAsync({
      requestId,
