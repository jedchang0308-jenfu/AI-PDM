import { withdrawNumberingCandidateBundleReview } from "@/lib/number-lifecycle-simplification";
import {
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await withdrawNumberingCandidateBundleReview({
    ...
    return numberStateFlowErrorResponse(error, "Candidate bundle review withdrawal failed.");
  }
}
