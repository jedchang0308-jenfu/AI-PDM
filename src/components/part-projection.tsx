...
export function PartProjection({ projection, showStatusBadge = true }: { projection: PdmProjectionEnvelope<PartProjectionSummary, PartProjectionFull>; showStatusBadge?: boolean }) {
