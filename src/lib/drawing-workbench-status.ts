...
type DrawingWorkbenchStatusSource = Omit<DrawingWorkbenchRow, "humanStatus" | "responsibilityStatus" | "viewerActionability" | "viewerStatus" | "availabilityScope" | "preview"> & { preview?: DrawingWorkbenchRow["preview"] };
