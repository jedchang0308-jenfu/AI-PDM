import { isBomXmindEditorV2Enabled } from "@/lib/bom-editor-feature";
...
export function assemblySharedBomV1ClientStatus(env: EnvLike = process.env) {
  ...
  const dependencies = {
    ...
    bomXmindEditorV2: isBomXmindEditorV2Enabled(env)
  };
  return {
    requested,
    enabled: requested && dependencies.unifiedPartRelationWorkbench && dependencies.bomXmindEditorV2,
