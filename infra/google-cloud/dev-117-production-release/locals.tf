locals {
  ...
  artifact_analysis_bucket        = "artifactanalysis-${var.region}-${data.google_project.current.number}"
  artifact_analysis_object_prefix = "projects/_/buckets/${local.artifact_analysis_bucket}/objects/asia-east1-docker.pkg.dev%2F${var.project_id}%2F${var.release_repository_id}%2F"
