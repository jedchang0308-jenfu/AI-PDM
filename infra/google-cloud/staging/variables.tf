...
variable "enable_firebase_hosting_gateway" {
  description = "Staging internal-pilot exception only. Enables Firebase Hosting rewrites by exposing the Cloud Run default URI; production must keep this false."
  type        = bool
  default     = false
}
...
variable "runtime_public_base_url" {
  ...
  type        = string
  default     = "https://pdm-stg.jenfu.com.tw"
...
variable "firebase_auth_domain" {
  ...
  type        = string
  default     = "ASSIGN_FIREBASE_AUTH_DOMAIN"
}
...
variable "database_tier" {
  description = "Staging single-zone database tier; production retains a separate regional-HA contract."
  type        = string
