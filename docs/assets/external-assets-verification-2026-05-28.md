...
- Manifest: `docs/assets/external-assets-manifest.json`
...
Command:
```powershell
npm.cmd run assets:verify -- --manifest docs/assets/external-assets-manifest.json
```

Output:
```text
> ai-pdm@0.1.0 assets:verify
> node scripts/verify-external-assets.mjs --manifest docs/assets/external-assets-manifest.json

{
  "manifestPath": "C:\\VIBE CODING\\AI_PDM\\docs\\assets\\external-assets-manifest.json",
