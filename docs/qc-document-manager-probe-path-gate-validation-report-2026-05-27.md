...
- Validation plan: `docs/qa-document-manager-probe-path-gate-validation-plan-2026-05-27.md`.
- RD report: `docs/rd-document-manager-probe-path-gate-report-2026-05-27.md`.
