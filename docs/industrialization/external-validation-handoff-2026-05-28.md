...
- `data/field-test-handoffs/20260528-203401`
- Package manifest: `data/field-test-handoffs/20260528-203401/field-test-handoff.json`
- Operator README: `data/field-test-handoffs/20260528-203401/README.md`
- Final checklist: `data/field-test-handoffs/20260528-203401/qc-checklist.ps1`

The package already contains copies of the current draft reports:

- Restore drill report copy: `data/field-test-handoffs/20260528-203401/reports/restore-drill-report.json`
- SolidWorks Add-in report copy: `data/field-test-handoffs/20260528-203401/reports/sw-addin-report.json`
- Document Manager report copy: `data/field-test-handoffs/20260528-203401/reports/document-manager-report.json`
...
```powershell
.\data\field-test-handoffs\20260528-203401\commands\document-manager-preflight.ps1
.\data\field-test-handoffs\20260528-203401\commands\document-manager-probe.ps1
.\data\field-test-handoffs\20260528-203401\commands\document-manager-fill-template.ps1
...
```powershell
.\data\field-test-handoffs\20260528-203401\commands\sw-addin-preflight.ps1
.\data\field-test-handoffs\20260528-203401\commands\sw-addin-build-and-register.ps1
.\data\field-test-handoffs\20260528-203401\commands\sw-addin-fill-template.ps1
...
- Restore handoff copied from `data/field-test-handoffs/20260528-203401/restore-handoff`.
- Backup snapshot and restore target directory recorded by the operator.

Commands:

```powershell
.\data\field-test-handoffs\20260528-203401\commands\restore-preflight.ps1
.\data\field-test-handoffs\20260528-203401\restore-handoff\restore-on-test-machine.ps1
.\data\field-test-handoffs\20260528-203401\commands\restore-fill-template.ps1
...
```powershell
.\data\field-test-handoffs\20260528-203401\qc-checklist.ps1
```
...
- Every failed field case is converted into a new `dev_task.md` item before `DEV-FIELD-001` is marked complete.
...
| Field-test issue loss | Failed field cases are not converted into tasks | Known defects disappear from backlog | Compare field report failures against `dev_task.md` | Create new tasks before closing `DEV-FIELD-001` |
