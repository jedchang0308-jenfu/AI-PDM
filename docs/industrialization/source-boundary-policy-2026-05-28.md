...
- Industrialization evidence and manifests: `docs/industrialization/`, `docs/assets/`
...
- `docs/assets/external-assets-manifest.json`
- `docs/assets/external-assets-verification-2026-05-28.md`
