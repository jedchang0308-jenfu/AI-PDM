...
- Validation plan: `docs/qa-document-manager-report-schema-upgrade-validation-plan-2026-05-27.md`.
- RD report: `docs/rd-document-manager-report-schema-upgrade-report-2026-05-27.md`.
