...
- Validation plan: `docs/qa-production-readiness-document-manager-gate-validation-plan-2026-05-27.md`.
- RD report: `docs/rd-production-readiness-document-manager-gate-report-2026-05-27.md`.
