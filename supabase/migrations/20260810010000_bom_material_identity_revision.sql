-- Add DEV-060 canonical material-owned BOM revision and idempotent create effects
-- Source: db/postgres/028_bom_material_identity_revision.sql
-- Source SHA-256: d63b3a1b71732cebb0df448bd606ea9ebfd6fe85070f1c74784a89cecd27235c
...
REVOKE ALL ON TABLE bom_create_effects FROM anon, authenticated;
REVOKE ALL ON TABLE bom_identity_migration_issues FROM anon, authenticated;
