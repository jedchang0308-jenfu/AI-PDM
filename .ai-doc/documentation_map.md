...
> **2026-09-05 Platform DEV-010 physical-topology successor（現行）**：AI-PDM `DEV-032`第一版production release維持已完成，但三系統共用資料庫的physical project／instance／database、schema placement與cross-app role契約改由Platform [DEV-010 direct spec](../../Jenfu-Management-system/ai-doc/specs/DEV-010-three-system-database-consolidation-contract.md) 接管。Platform production bootstrap的database ACL已由hard-coded `jenfu_dev010`前向修正為identifier-safe `current_database()`，exact-target guard仍在DDL前；fresh N1A=`11/11 unit＋30/30 QC PASS`，三repo detached exact-HEAD N2=`48/48 PASS`，aggregate=`../../Jenfu-Management-system/output/dev-010/n2/aggregate/AGGREGATE-20260904T164946034Z-9908/aggregate-report.json`、SHA-256=`548f54f43ee2896c0ac448789dd6905fefd72da9e241d937f603f75a246d5a1b`，Platform contract commit=`088580e`。Current production target=`db-custom-1-3840 / ZONAL_DEDICATED / USD 100`；backup、PITR、deletion protection、private IAM與schema-role隔離不變，HA延後且不得宣稱automatic cross-zone failover。舊`jenfu-ai-pdm-prod / ai-pdm-prod-postgres / ai_pdm`及`DEV-032`證據是第一版provenance，不代表neutral topology終態。Current R1 source lock須按最新三repo HEAD重建，且9項human／target／capacity blocker及15案provider execution仍未完成；production migration、deploy、DNS、authority／traffic switch仍只能由獨立`010-R1` release gate啟動，AI-PDM write smoke另要求Platform R1-07與DEV-116 R02共用exact company-smoke receipt。
...
| Need | Read |
|---|---|
| DEV-116 Production Level 4 smoke tenant隔離與可稽核證據關卡 | `.ai-doc/dev_task.md` (`DEV-116 / DEV-PDM-PRODUCTION-SMOKE-TENANT-ISOLATION-001`)；focused SPEC `.ai-doc/specs/SPEC-PDM-PRODUCTION-SMOKE-TENANT-001-level4-isolation-and-evidence.md`；fixed QA `.ai-doc/qa/qa-dev-116-production-smoke-tenant-isolation-validation-plan-2026-09-04.md`；machine registry `.ai-doc/qa/dev-116-current-case-registry.json`；R01 report `.ai-doc/reports/pm/pm-dev-116-r01-production-release-preflight-2026-09-04.md`；release capsule=`output/production-release/REL-116-20260904/capsule.json`。Status: `Local 31/31 PASS / R02 Receipt 5/5 + Browser 7/7 + Platform Provider Producer 5/5 PASS / Pipeline 25/25 / DEV-010 bootstrap requalification N1A 11+30 and N2 48/48 PASS / 116-R R01 BLOCKED / R02-R03 NOT_RUN`。Production仍為legacy `public` ledger 53／056，DEV-010 roles/contracts/062不存在；legacy migration package為54支且硬排除DEV-010-owned 062。Legacy `db-f1-micro／USD 300`不是DEV-010 neutral authority。R02雙producer已local implemented，但只接受READY preflight與same-execution neutral candidate／SMOKE evidence；browser-only或provider-readback-only都不能冒充Level 4。Current 9 blockers為neutral identity、RTO、RPO、budget／restore／incident owners、maintenance window／owner及production capacity；15案provider-native execution仍未執行。Workflow固定`prepare→candidate→promote`；R04 smoke增量成本upper bound=`USD 0.020812/run`、10 runs=`USD 0.208120/month`、fixed SKU=0。Production writes/deploy/traffic/principal provisioning均為0。 |
