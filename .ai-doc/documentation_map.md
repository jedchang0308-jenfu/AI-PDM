...
> **2026-09-08 DEV-117 continuous v2 authority（現行）**：current owner docs為[DEV-117 SPEC §§21～22](specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md)與[QA-DEV-117 forward amendments](qa/qa-dev-117-ai-pdm-independent-production-deployment-validation-plan-2026-09-07.md)，上游是Platform DEV-012 §25（contract SHA-256=`47eb972c48549da73ca135509e99bdc8ae4463e87b81785abe8d6cfd8f54b95f`；§25～EOF=`92fd6c7dfdfafee4b438c0ee9ce731d7463da46a7691f05061c54d58cb127507`）。狀態=`continuous v2 Implementation Complete / S1B-20 LOCAL_CONTRACT PASS / DEV-012 S2 Gated`。v1六階段dispatch、手貼receipt、run中Product Owner GO與固定觀察期只保留歷史證據；v2採two-capsule、nine-stage machine decision、immediate abort與own-only rollback。正式provider資源、migration、candidate與traffic仍待S2／S3 native evidence。
>
