...
> **2026-09-22 DEV-118 Production current checkpoint（現行）**：118-C current owner run `35669545522`已把main `6e21bb4c2f39d4b4777320d202a2037bde609b00`發布為`ai-pdm-prod-f5ee2af2d7ec`，image `sha256:fee7d3e6f653e29332a77a87ca53fa897b76aed215dcdee54f16fd585fde10bd`承接100% traffic；explicit local logout correction與current conformance均已發布。Workspace Platform→AI-PDM免二次登入、reload、帳號管理與permission PASS；global logout後AI-PDM protected APIs均401。這認列`PDM-W-G`與global invalidation的current evidence；工號callback、Free與negative／race cells仍缺，C01／C02四格及LOGIN六案未full PASS。下方舊的production NOT_RUN／release pending文字均保留為歷史。
