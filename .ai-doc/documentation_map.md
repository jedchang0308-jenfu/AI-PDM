...
| Need | Read |
|---|---|
| DEV-116 Production Level 4 smoke tenant隔離與可稽核證據關卡 | `.ai-doc/dev_task.md` (`DEV-116 / DEV-PDM-PRODUCTION-SMOKE-TENANT-ISOLATION-001`)；focused SPEC `.ai-doc/specs/SPEC-PDM-PRODUCTION-SMOKE-TENANT-001-level4-isolation-and-evidence.md`；fixed QA `.ai-doc/qa/qa-dev-116-production-smoke-tenant-isolation-validation-plan-2026-09-04.md`；machine registry `.ai-doc/qa/dev-116-current-case-registry.json`；R01 report `.ai-doc/reports/pm/pm-dev-116-r01-production-release-preflight-2026-09-04.md`；Platform DEV-010 QC由其direct spec索引。Status: `Local 31/31 PASS / R02 Receipt 5/5 + Browser 7/7 + Platform Provider Producer 5/5 PASS / Pipeline 25/25 / DEV-010 15-case Machine Source Paths Complete / R1-15 7/7＋R1-14 7/7＋R1-09 10/10＋Release 19/19＋Preflight 16/16 PASS / Provider A/F/B and All Actual Case Execution NOT_RUN / Production Binding Gated / 116-R R01 BLOCKED / R02-R03 NOT_RUN`。Production仍為legacy `public` ledger 53／056，DEV-010 roles/contracts/062不存在；legacy `db-f1-micro／USD 300`不是DEV-010 neutral authority。R02與R1-07仍共同承擔唯一Production Level 4 write path；R1-15只證明tabletop operational readiness，不切traffic、不執行cleanup、不送external notification且不增加R02分子。Provider-attested artifacts、正式scan receipt、必要時F及B provider execution、reviewed evidence、正式`063→062`、exact IAM membership、9項preflight與15案actual execution仍未完成。R04 smoke增量成本upper bound=`USD 0.020812/run`、10 runs=`USD 0.208120/month`、fixed SKU=0；temporary clone只列transition cost，不調高固定budget。Production writes/deploy/traffic/principal／membership provisioning、secret disable及legacy retirement均為0。 |
