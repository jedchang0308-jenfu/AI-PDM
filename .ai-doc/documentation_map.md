...
| Need | Read |
|---|---|
| DEV-116 Production Level 4 smoke tenant隔離與可稽核證據關卡 | `.ai-doc/dev_task.md` (`DEV-116 / DEV-PDM-PRODUCTION-SMOKE-TENANT-ISOLATION-001`)；focused SPEC `.ai-doc/specs/SPEC-PDM-PRODUCTION-SMOKE-TENANT-001-level4-isolation-and-evidence.md`；fixed QA `.ai-doc/qa/qa-dev-116-production-smoke-tenant-isolation-validation-plan-2026-09-04.md`；machine registry `.ai-doc/qa/dev-116-current-case-registry.json`；R01 report `.ai-doc/reports/pm/pm-dev-116-r01-production-release-preflight-2026-09-04.md`；release capsule=`output/production-release/REL-116-20260904/capsule.json`；cross-repo readiness=`output/production-release/REL-116-20260904/r01-cross-repo-readiness.json`。Status: `Local 31/31 PASS / 116-R R01 Started / Production Read-only Preflight Complete / DEV-010 R1 Dependency＋Production Adapter＋Source Freeze Blocked / R02-R03 NOT_RUN`。Production仍為legacy `public` ledger 53／056，DEV-010 roles/contracts/062不存在；legacy migration package為54支（既有53＋063）且硬排除DEV-010-owned 062。三repo source freeze全數FAIL；Platform `010-R1A` local preflight已完成6/6 unit＋QC並machine-report 10 blockers，但production rehearsal／apply runner不存在、neutral project identity仍ambiguous。Workflow已拆`prepare→candidate→promote`，candidate要求migration／DEV-010／principal／cost evidence與三個side-effect disabled readback。R04 official-price gross gate=`USD 0.020812/run`、10 runs=`USD 0.208120/month`、fixed SKU=0、30日失效；不把DEV-010 REGIONAL/ZONAL固定成本混為smoke成本。Production writes/deploy/traffic/principal provisioning均為0。 |
