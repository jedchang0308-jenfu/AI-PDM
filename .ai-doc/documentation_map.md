...
> **2026-09-16 DEV-118 正式 Google 登入修復（現行待排）**：production canonical host已在Firebase authorized domains，
> 但Google authorization start回`OPERATION_NOT_ALLOWED: The identity provider configuration is not found.`；
> `/api/auth/mode`仍因web config完整而宣告Google enabled，client再落入通用「請稍後再試」。新建
> [DEV-118 SPEC](specs/SPEC-PDM-PRODUCTION-GOOGLE-SIGN-IN-READINESS-001-provider-capability-and-entrypoint-gate.md)，
> 狀態=`RD Contract Ready / P0 / Production Provider Change and Release Gated`。修復責任分為app capability／錯誤UX、
> shared provider prerequisite、provider-start＋authenticated release evidence；本文件不授權live provider、credential、
> production runtime或traffic mutation。

> **2026-09-15 DEV-117／DEV-012 R78完成（現行）**：AI-PDM frozen source=`91de3a65df58dc60ddde88aab5263e9470a84565`已由owner run `34952087442`完成十階段正式release；revision=`ai-pdm-prod-29a4a765563c`、100% traffic、canonical=`https://ai-pdm-prod-9536592944.asia-east1.run.app`，owner terminal=`RELEASED`、`remainingHumanAction=0`。151 tables／3,569 rows cutover與identity／row／hash／FK reconciliation、authenticated smoke、rollback與cleanup均PASS。Current authority為[DEV-117 SPEC最終節](specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md)及[QA最終節](qa/qa-dev-117-ai-pdm-independent-production-deployment-validation-plan-2026-09-07.md)。後續ordinary release由本repo獨立執行；下方`S2 Unlocked／Production NOT_RUN`只屬歷史里程碑。
...
> **2026-09-09 DEV-117 continuous V3 authority（現行）**：current owner docs為[DEV-117 SPEC §23](specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md)與[QA-DEV-117 V3 amendment](qa/qa-dev-117-ai-pdm-independent-production-deployment-validation-plan-2026-09-07.md)，上游是Platform DEV-012 §26（contract SHA-256=`d88b9aaa8a5e27082746221fc5b473abd8a78da712409279baf5ecdb0e176f05`）。狀態=`Architecture Finalized / RD Tech Lead PASS / P0=0 / P1=0 / V3 Implementation Complete / S1B-20 Owner PASS / DEV-012 S1C 8／8 PASS / S2 Unlocked, Not Started`。AI-PDM canonical entry為provider-verified `https://ai-pdm-prod-9536592944.asia-east1.run.app`；workflow為十stage並含app-owned entrypoint。V1六階段與V2九階段只保留歷史；正式provider資源、migration、candidate、entrypoint與traffic仍待S2／S3 native evidence。
>
...
| Need | Read |
|---|---|
| DEV-118 正式 Google 登入可用性與能力放行修復 | `.ai-doc/dev_task.md` (`DEV-118 / DEV-PDM-PRODUCTION-GOOGLE-SIGN-IN-READINESS-001`)；SPEC `.ai-doc/specs/SPEC-PDM-PRODUCTION-GOOGLE-SIGN-IN-READINESS-001-provider-capability-and-entrypoint-gate.md`；identity authority `.ai-doc/specs/SPEC-PDM-ACCESS-CONTROL-001-user-identity-permission-architecture.md`；release authority `DEV-117`。Status: `RD Contract Ready / P0 / Production Provider Change and Release Gated`。Canonical host已authorized，但production `google.com` provider config缺失；current UI capability與release smoke均未覆蓋此失效。下一步由shared identity／Platform owner確認provider mutation與回復責任，再固定repo-level implementation／QA contract；DB migration=`none`。 |
| DEV-117 AI_PDM 獨立正式部署 adapter | `.ai-doc/dev_task.md` (`DEV-117 / DEV-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001`)；SPEC `.ai-doc/specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md` §23；QA `.ai-doc/qa/qa-dev-117-ai-pdm-independent-production-deployment-validation-plan-2026-09-07.md` §14；registry `.ai-doc/qa/dev-117-current-case-registry.json`；V3 profile `config/release/dev117-ai-pdm-independent-production-v3.json`；workflow `.github/workflows/deploy-ai-pdm-independent-production.yml`；Platform對稱authority `../../Jenfu-Platform/ai-doc/specs/DEV-011-independent-platform-production-deployment-contract.md`。Status: `Architecture Finalized / RD Tech Lead PASS / P0=0 / P1=0 / V3 Owner Implementation Complete / S1B-20 PASS / DEV-012 S1C 8 of 8 PASS / S2 Unlocked / Provider NOT_RUN / Production Release Gated`。正式release需S2 fresh source、Billing／quota／Identity／IAM／Secret／foundation／APP_INFRA／entry baseline，再由S3完成DEV-116 R02、machine GO與canonical evidence。 |
| DEV-116 Production Level 4 smoke tenant隔離與可稽核證據關卡 | `.ai-doc/dev_task.md` (`DEV-116 / DEV-PDM-PRODUCTION-SMOKE-TENANT-ISOLATION-001`)；focused SPEC `.ai-doc/specs/SPEC-PDM-PRODUCTION-SMOKE-TENANT-001-level4-isolation-and-evidence.md`；fixed QA `.ai-doc/qa/qa-dev-116-production-smoke-tenant-isolation-validation-plan-2026-09-04.md`；machine registry `.ai-doc/qa/dev-116-current-case-registry.json`；R01 report `.ai-doc/reports/pm/pm-dev-116-r01-production-release-preflight-2026-09-04.md`。Status: `Local 31/31 PASS / Legacy 063 Apply + Rerun + Readback Complete / Legacy Ledger 54 Highest 063 / Neutral candidate and R01-R03 NOT_RUN / Deployment lane owned by DEV-117`。DEV-116只擁有`company-smoke` authenticated Level 4與Jenfu zero-leak evidence；candidate／promotion／rollback／live receipt由DEV-117擁有。Legacy `jenfu-ai-pdm-prod` service仍承接100% traffic，且不得替代neutral target；`jenfu-platform-prod billingEnabled=false`。 |
| DEV-032 production release closure | `.ai-doc/dev_task.md` (`DEV-032`)；QC `.ai-doc/qc/qc-dev-032-production-release-closure-2026-09-03.md`；manifest `output/qa/dev-032-production-release/final-release-manifest.json`；candidate run evidence `output/qa/dev-032-production-release/run-33729286511/`；promotion evidence `output/qa/dev-032-production-release/run-33730726544/`。Status: `Production Released / Gate A-E PASS / Closed`；canonical URL=`https://jenfu-ai-pdm-prod.web.app`，source=`bb30682c`，revision=`ai-pdm-prod-gh-bb30682c-33729286511`，traffic=100%，canonical smoke=14/14。 |
| DEV-115 QA gate convergence／DEV-079與DEV-080 current closure | `.ai-doc/dev_task.md` (`DEV-115/079/080`)；registries `.ai-doc/qa/dev-079-current-case-registry.json`、`.ai-doc/qa/dev-080-current-case-registry.json`；QA amendments `.ai-doc/qa/qa-dev-079-drawing-readonly-drawer-fullpage-workspace-validation-plan-2026-08-19.md`、`.ai-doc/qa/qa-dev-080-system-status-visibility-validation-plan-2026-08-19.md`；QC `.ai-doc/qc/qc-dev-115-qa-gate-convergence-2026-09-03.md`。Status: `DEV-115 Complete / DEV-079 Current Matrix 42 of 42 PASS / DEV-080 Current Matrix 12 of 12 PASS and Merged into DEV-087/112 / Production Release Owned by DEV-032`。Final manifests=`output/qa/dev-115-qa-gate-convergence/DEV115-DEV-079-2026-09-03T04-49-20-491Z/aggregate-manifest.json`與`DEV115-DEV-080-2026-09-03T04-50-38-215Z/aggregate-manifest.json`；primary invariant與task-owned cleanup均PASS。 |
| DEV-106 退役Relation/BOM殘留清除與recovery防回流 | `.ai-doc/dev_task.md` (`DEV-106`)；SPEC `.ai-doc/specs/SPEC-PDM-RETIREMENT-RESIDUE-CLEANUP-001-forward-only-recovery-guard.md`；QA `.ai-doc/qa/qa-dev-106-retired-residue-cleanup-validation-plan-2026-08-30.md`；local receipt `.ai-doc/qc/qc-dev-106-local-release-readiness-2026-08-30.md`；PostgreSQL `db/postgres/052_retired_workbench_residue_cleanup.sql`；focused QC `scripts/qc-dev-106-retired-residue-cleanup.mjs`與`scripts/qc-dev-106-postgres-retirement.mjs`。Status: `Local RD + Pre-release QA/QC Complete / 13 of 13 Local Gates PASS / Production Release Owned by DEV-032`。只清除空Relation work schema與Part work JSON的退役BOM key，保留正式drawing-part links、canonical identities與歷史evidence；recovery mapper不得再重播042。 |
| DEV-104 BOM 工作台 V2（歷史計畫） | `.ai-doc/dev_task.md` (`DEV-104 / DEV-PDM-BOM-WORKBENCH-V2-001`)及原SPEC只供追溯。Status: `Historical Planning Only / Superseded by DEV-095 BOM Hard Retirement / Do Not Implement or Restore`。原48-case分母與RD Implementation Ready狀態已撤回，不是current acceptance authority。 |
...
| DEV-095 BOM 模組硬刪除 | `.ai-doc/dev_task.md` (`DEV-095`)；ADR `.ai-doc/decisions/ADR-PDM-BOM-RETIREMENT-001-hard-delete-and-rebuild-boundary.md`；QA `.ai-doc/qa/qa-dev-095-bom-retirement-validation-plan-2026-08-24.md`；QC `.ai-doc/qc/qc-dev-095-bom-retirement-2026-08-24.md`；PostgreSQL `db/postgres/047_remove_bom_module.sql`；SQLite runner `scripts/migrate-dev-095-bom-retirement.mjs`。Status: `BOM Hard Retirement Integrated / Focused QC PASS / Isolated Build Pending / Production Execution Authorized and Release-Gated`。現行產品不提供BOM、Where-used、結構分類或舊BOM審核契約；舊spec/QA/QC/report只供歷史，不能作current acceptance authority。 |
| DEV-099 結構型態延後分類與 BOM readiness 解耦（歷史） | `.ai-doc/dev_task.md` (`DEV-099`)及原SPEC／ADR／QA只供追溯。Status: `Historical / Superseded by DEV-095 BOM Hard Retirement / Do Not Restore`。BOM readiness、Part結構分類UI與專用驗證已移除。 |
| DEV-096 組立件情境式共用 BOM 重建（歷史） | `.ai-doc/dev_task.md` (`DEV-096`)及原SPEC／ADR／QA/QC只供追溯。Status: `Historical / Superseded by DEV-095 BOM Hard Retirement / Do Not Restore`。產品、schema/migration、flag與專用驗證已移除。 |
...
| DEV-079 圖號唯讀抽屜與全頁編輯工作區分流 | `.ai-doc/dev_task.md` (`DEV-079`, CAPA-corrected); primary authority `.ai-doc/specs/SPEC-PDM-ENTITY-DETAIL-DRAWER-001-unified-object-detail-contract.md`；QA `.ai-doc/qa/qa-dev-079-drawing-readonly-drawer-fullpage-workspace-validation-plan-2026-08-19.md`；closure `.ai-doc/qc/qc-dev-115-qa-gate-convergence-2026-09-03.md`。Status: `Local RD/QA-QC Complete / Current Matrix 42 of 42 PASS / Closed`。Canonical routes、drawer zero-write、accepted-state invariant與controlled reconciliation evidence保留；不再列獨立actor/failure matrix待辦。 |
| DEV-080 全系統第一層狀態可見性與例外分層 | `.ai-doc/dev_task.md` (`DEV-080`); authority `.ai-doc/specs/SPEC-PDM-STATUS-UX-005-first-layer-status-visibility-policy.md`; QA `.ai-doc/qa/qa-dev-080-system-status-visibility-validation-plan-2026-08-19.md`; closure `.ai-doc/qc/qc-dev-115-qa-gate-convergence-2026-09-03.md`。Status: `Local QA-QC Complete 12 of 12 / Merged into DEV-087 and DEV-112 / Closed`。現行presentation authority由successors承接；歷史projection/browser evidence只供追溯，不再形成獨立派工或release owner。 |
...
| DEV-069 AI-PDM 預上線 GCP 降本與低成本 Staging | `.ai-doc/dev_task.md` (`DEV-069`, merged source); implementation authority `.ai-doc/specs/SPEC-PDM-GCP-COST-OPTIMIZATION-001-prelaunch-runtime-topology.md`; decision `.ai-doc/decisions/ADR-PDM-GCP-COST-OPTIMIZATION-001-prelaunch-firebase-hosting-zonal-micro.md`。Status: `Local RD/QC Closed / First-version Live Release Obligation Completed through DEV-032 / Closed`。本地topology與targeted QC保留；未來成本或staging架構調整須依新需求另立DEV，DEV-069不再是active release owner。 |
...
- First-version production release is complete. Production authority is Firebase Hosting → Cloud Run → Cloud SQL PostgreSQL; the first-version file workflow remains fail-closed and Supabase remains retired. `DEV-032 Gate A-E` closed with current candidate-bound evidence on 2026-09-03. Future source, migration, scope or authority changes require a new release capsule; DEV-046 Phase 3B+ remains future scope.
- 2026-08-11 DEV-032 production evidence reconciliation is retained as historical release evidence: target preflight/live readback, Cloud Run, Cloud SQL, backup/PITR/deletion protection, private restore, principal, migration/reconciliation and production-slice checks passed for its exact artifact. Its prior authenticated Level 4 remains historical and cannot satisfy a newer candidate. The active A9 is now `A9-production-go-no-go`; named-user Wave 0 and waiver fields are retired. Evidence lives in `config/platform/production-activation-evidence.json`, `output/dev-032-production-live-readback/report.json`, `output/dev-032-production-slice-activation/github-f70c8982-release-evidence.json` and `output/dev-032-production-activation-readiness/report.json`.
...
- 2026-08-11 branch predeploy verification: `qc:full` passed 42/42 steps and `qc:industrialization` passed 41/41 steps, including isolated dev and standalone production API/UI/file-integrity execution; target preflight passed 16/16, activation readiness passed 18/18, and the dependency audit reported zero vulnerabilities. These are historical exact-artifact results. Current readiness remains blocked by any missing current-release Level 4, zero-open-P0/P1, rollback, Product Owner GO or exact promotion evidence; named-user Wave 0 is no longer requested.
...
- First-version launch evidence split: `DEV-IND-007` is complete for disposable local PostgreSQL compatibility. `DEV-FIELD-001` and its fixed observation were cancelled by `HD-9-1` on 2026-07-14. On 2026-08-29 the remaining named-user Wave 0 acceptance and waiver path were permanently retired. `DEV-032` retains exact-artifact provenance, applicable migration/restore reconciliation, zero-traffic candidate, authenticated Level 4, zero open P0/P1, rollback readiness, Product Owner GO, explicit traffic promotion and canonical post-promotion smoke. Production access allowlist changes remain separate security administration. `DEV-CAD-001`, `DEV-SW-001`, and `DEV-BACKUP-001` remain deferred full-PDM scopes.
