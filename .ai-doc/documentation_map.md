...
| Need | Read |
|---|---|
| DEV-116 Production Level 4 smoke tenant隔離與可稽核證據關卡 | `.ai-doc/dev_task.md` (`DEV-116 / DEV-PDM-PRODUCTION-SMOKE-TENANT-ISOLATION-001`)；focused SPEC `.ai-doc/specs/SPEC-PDM-PRODUCTION-SMOKE-TENANT-001-level4-isolation-and-evidence.md`；fixed QA `.ai-doc/qa/qa-dev-116-production-smoke-tenant-isolation-validation-plan-2026-09-04.md`；machine registry `.ai-doc/qa/dev-116-current-case-registry.json`；R01 report `.ai-doc/reports/pm/pm-dev-116-r01-production-release-preflight-2026-09-04.md`；Platform R1-04A/F/B、R1O、R1R、R1S、R1U、R1V、R1W與R1X QC均由Platform DEV-010 direct spec索引。Status: `Local 31/31 PASS / R02 Receipt 5/5 + Browser 7/7 + Platform Provider Producer 5/5 PASS / Pipeline 25/25 / DEV-010 R1E Local 14+4 and N2 48/48 PASS / R1-04A Artifact Producer 6/6＋R1-04B/F/IaC 22/22＋R1O Release 19/19＋R1V 10/10＋R1W 7/7＋R1X 8/8 PASS / Provider A/F/B Execution NOT_RUN / R1-05, R1-06, R1-08, R1-09, R1-10 and R1-12 Evidence Sources Implemented / R1-13/14/15 Executors NOT_IMPLEMENTED / Production Binding Gated / 116-R R01 BLOCKED / R02-R03 NOT_RUN`。Production仍為legacy `public` ledger 53／056，DEV-010 roles/contracts/062不存在；legacy `db-f1-micro／USD 300`不是DEV-010 neutral authority。R02與R1-07仍共同承擔唯一Production Level 4 write path；R1-10只證明consumer退役就緒，actual retirement／deletion另受post-promotion gate，R1-12只停用跨所有revision／job零引用的superseded secret，previous rollback與current版本必須保留。Provider-attested artifacts、正式scan receipt、必要時F及B provider execution、reviewed runtime／rollback／write-fence／observation／retirement／rotation plans、正式`063→062`、exact IAM membership、9項preflight與15案actual execution仍未完成。Workflow固定build-once、fail-closed missing-service foundation、digest-only candidate、獨立promote與promotion後legacy retirement；R04 smoke增量成本upper bound=`USD 0.020812/run`、10 runs=`USD 0.208120/month`、fixed SKU=0，R1-04A／F／B一次性build／artifact／secret version成本另列transition receipt。Production writes/deploy/traffic/principal／membership provisioning、secret disable及legacy retirement均為0。 |
