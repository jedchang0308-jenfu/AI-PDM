...
| Need | Read |
|---|---|
| DEV-116 Production Level 4 smoke tenant隔離與可稽核證據關卡 | `.ai-doc/dev_task.md` (`DEV-116 / DEV-PDM-PRODUCTION-SMOKE-TENANT-ISOLATION-001`)；focused SPEC `.ai-doc/specs/SPEC-PDM-PRODUCTION-SMOKE-TENANT-001-level4-isolation-and-evidence.md`；fixed QA `.ai-doc/qa/qa-dev-116-production-smoke-tenant-isolation-validation-plan-2026-09-04.md`；machine registry `.ai-doc/qa/dev-116-current-case-registry.json`；R01 report `.ai-doc/reports/pm/pm-dev-116-r01-production-release-preflight-2026-09-04.md`；release capsule=`output/production-release/REL-116-20260904/capsule.json`。Status: `Local 31/31 PASS / DEV-010 N2 clean 48/48 PASS / 116-R R01 Started / Production Read-only Preflight Complete / R02-R03 NOT_RUN`。Production仍為legacy `public` ledger 53／056，DEV-010 roles/contracts/062不存在；legacy migration package為54支且硬排除DEV-010-owned 062。三repo post-commit HEAD＋tree lock已完成，current R1A只剩neutral project identity與exact REGIONAL dedicated tier／cost兩項blocker；production 15案runner仍須實作與獨立QC。Workflow固定`prepare→candidate→promote`；R04 smoke增量成本upper bound=`USD 0.020812/run`、10 runs=`USD 0.208120/month`、fixed SKU=0。Production writes/deploy/traffic/principal provisioning均為0。 |
