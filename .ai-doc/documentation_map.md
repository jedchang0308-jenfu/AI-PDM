...
| Need | Read |
|---|---|
| DEV-116 Production Level 4 smoke tenant隔離與可稽核證據關卡 | `.ai-doc/dev_task.md` (`DEV-116 / DEV-PDM-PRODUCTION-SMOKE-TENANT-ISOLATION-001`)；focused SPEC `.ai-doc/specs/SPEC-PDM-PRODUCTION-SMOKE-TENANT-001-level4-isolation-and-evidence.md`；fixed QA `.ai-doc/qa/qa-dev-116-production-smoke-tenant-isolation-validation-plan-2026-09-04.md`；machine registry `.ai-doc/qa/dev-116-current-case-registry.json`；R01 report `.ai-doc/reports/pm/pm-dev-116-r01-production-release-preflight-2026-09-04.md`；Platform R1-04A QC `../Jenfu-Management-system/ai-doc/qc/qc-dev-010-r1-04a-local-container-package-2026-09-05.md`；Platform R1-04F QC `../Jenfu-Management-system/ai-doc/qc/qc-dev-010-r1-04f-service-foundation-2026-09-05.md`；Platform R1-04B QC `../Jenfu-Management-system/ai-doc/qc/qc-dev-010-r1-04b-candidate-producer-2026-09-05.md`；Platform R1O QC `../Jenfu-Management-system/ai-doc/qc/qc-dev-010-r1-operational-evidence-2026-09-05.md`；Platform R1R QC `../Jenfu-Management-system/ai-doc/qc/qc-dev-010-r1-05-provider-capture-executor-2026-09-05.md`；Platform R1S QC `../Jenfu-Management-system/ai-doc/qc/qc-dev-010-r1-08-rollback-readiness-executor-2026-09-05.md`；Platform R1U QC `../Jenfu-Management-system/ai-doc/qc/qc-dev-010-r1-06-final-zero-delta-finalizer-2026-09-05.md`；Platform R1V QC `../Jenfu-Management-system/ai-doc/qc/qc-dev-010-r1-09-read-only-observation-executor-2026-09-05.md`；release capsule=`output/production-release/REL-116-20260904/capsule.json`。Status: `Local 31/31 PASS / R02 Receipt 5/5 + Browser 7/7 + Platform Provider Producer 5/5 PASS / Pipeline 25/25 / DEV-010 R1E Local 14+4 and N2 48/48 PASS / R1-04A Artifact Producer 6/6＋R1-04B/F/IaC 22/22＋R1O Release 19/19＋R1V 10/10 PASS / Provider A/F/B Execution NOT_RUN / R1-05, R1-06, R1-08 and R1-09 Provider Evidence Sources Implemented / Five Remaining Operational Provider Executors NOT_IMPLEMENTED / Production Binding Gated / 116-R R01 BLOCKED / R02-R03 NOT_RUN`。Production仍為legacy `public` ledger 53／056，DEV-010 roles/contracts/062不存在；legacy `db-f1-micro／USD 300`不是DEV-010 neutral authority。R02雙producer、read-only provider executor、R1-05四來源capture、R1-06 write-fence／zero-delta finalizer、R1-08 rollback-readiness與R1-09 observation executor均已local implemented，但只接受READY preflight與same-execution neutral candidate evidence；browser-only、provider-readback-only、R1-06 read-only receipt或local fixture都不能冒充Level 4。P0 verifier、container package、R1-04A／F／B executor source、九案typed evidence、R1-05 capture、R1-06 finalization及R1-08／09 source gap已關閉；current 8項foundation blocker與A／F／runtime evidence缺件讓executor在provider auth前停止。Provider-attested artifacts、正式scan receipt、必要時F及B provider execution、reviewed runtime／rollback／write-fence／observation plan、其餘五案provider executors、正式`063→062`、exact IAM membership、9項preflight與15案actual execution仍未完成。Workflow固定build-once、fail-closed missing-service foundation、digest-only candidate與獨立promote；R04 smoke增量成本upper bound=`USD 0.020812/run`、10 runs=`USD 0.208120/month`、fixed SKU=0，R1-04A／F／B一次性build／artifact／secret version成本另列transition receipt。Production writes/deploy/traffic/principal／membership provisioning均為0。 |
