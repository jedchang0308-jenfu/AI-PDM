...
| DEV-118 平台登入入口與 Google／工號契約 | [任務板](dev_task.md) → [PDM SPEC](specs/SPEC-PDM-PRODUCTION-GOOGLE-SIGN-IN-READINESS-001-provider-capability-and-entrypoint-gate.md)；[118-A QC](qc/qc-dev-118-local-implementation-2026-09-17.md)；[118-B 歷史查核](qc/qc-dev-118-platform-handoff-readonly-2026-09-17.md)。118-A Local Complete（contract 10/10、browser 12/12）；118-B owner-native=[Platform DEV-014／014-LOGIN](../../Jenfu-Platform/ai-doc/specs/DEV-014-managed-identity-production-activation.md#dev014-login)，Contract Ready／六案未執行，G1～G4 待閉合。2026-09-17 複審將平台規則集中於 §18：Workspace／Free 共用 Google、重用 pending bridge、不回 pre-auth hint；PDM 只持 target admission 與 C01／C02 四個整合 cells，與 LOGIN-06 共用證據。R2 基線 QA 0／20 與 LOGIN 分開；118-C Release Gated，無產品／provider 變更。 |
