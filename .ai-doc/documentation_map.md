...
> **2026-09-08 DEV-117 continuous v2 authority（現行）**：current owner docs為[DEV-117 SPEC §§21～23](specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md)與[QA-DEV-117 forward amendments](qa/qa-dev-117-ai-pdm-independent-production-deployment-validation-plan-2026-09-07.md)，上游是Platform DEV-012 §§25～26（contract SHA-256=`c29974332ae0193bec330870b84a00766c6ae759b7d1522adc4faddc16490c3b`；§25～EOF=`8a80235f2d54375738f89741ed93e1c341894113ffba91bfbed3320df8b1548b`）。狀態=`runtime bridge implemented / S1B-20 re-entry pending / DEV-012 S2 Gated`。v1六階段dispatch、手貼receipt、run中Product Owner GO與固定觀察期只保留歷史證據；v2採two-capsule、nine-stage machine decision、complete runtime template、immediate abort與own-only rollback。正式provider資源、migration、candidate與traffic仍待S2／S3 native evidence。
>
