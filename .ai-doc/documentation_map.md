...
| DEV-118 平台登入入口與 Google／工號契約 | [任務板](dev_task.md) → [唯一 SPEC](specs/SPEC-PDM-PRODUCTION-GOOGLE-SIGN-IN-READINESS-001-provider-capability-and-entrypoint-gate.md)；[118-A QC receipt](qc/qc-dev-118-local-implementation-2026-09-17.md)；[118-B 歷史唯讀查核](qc/qc-dev-118-platform-handoff-readonly-2026-09-17.md)。118-A=`Local RD／QA-QC Complete`（contract 10/10、browser 12/12）；118-B 已依 2026-09-17 兩專案文件授權登錄 [Platform DEV-014／014-LOGIN](../../Jenfu-Platform/ai-doc/specs/DEV-014-managed-identity-production-activation.md#dev014-login)，狀態 `RD Contract Ready / Implementation NOT_RUN`，LOGIN 六案未執行。Platform R2 基線另維持 Architecture Finalized／QA 0／20。Workspace 與 Cloud Identity Free 都走 Google；工號只找到核准身分，canonical 為 Firebase issuer＋UID，無 Gmail 不須另建密碼 provider。§6.1 定義無 Gmail 開通；既有 non-Google 保留相容 gate。118-C 依 SSO／release gate；不新增 PDM provider probe、自有 password 或 Workflow 契約。 |
