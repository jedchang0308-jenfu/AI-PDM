...
| DEV-118 平台登入入口與 Google／工號契約 | [任務板](dev_task.md) → [PDM SPEC](specs/SPEC-PDM-PRODUCTION-GOOGLE-SIGN-IN-READINESS-001-provider-capability-and-entrypoint-gate.md)；[118-A QC](qc/qc-dev-118-local-implementation-2026-09-17.md)；[118-B 現行交接審查與歷史](qc/qc-dev-118-platform-handoff-readonly-2026-09-17.md)。118-A本地補修完成：contract 10/10；2026-09-21 exact snapshot browser 30/30、typecheck、affected lint 0 error及isolated build PASS，manifest=`output/qa/dev-118-login-entry/DEV118-browser-2026-09-21T03-13-12-373Z/manifest.json`。118-B owner-native=[Platform DEV-014／014-LOGIN](../../Jenfu-Platform/ai-doc/specs/DEV-014-managed-identity-production-activation.md#dev014-login)＋[OrgMaster DEV-049](../../OrgMaster/ai-doc/specs/DEV-049-existing-google-primary-account-link.md)，Local Development Complete／Architecture Finalized LOGIN-R1；固定staging owner／target readback可重用，缺fixture僅代表選配staging runner未執行。DEV-118現為`Validation Pending`；118-C採Protected Release，沿既有DEV-117 owner workflow build一次並在production canonical完成LOGIN六案與PDM C01／C02，不新增專屬staging或第二次批准。 |
