...
| Need | Read |
|---|---|
| DEV-104 BOM 工作台 V2 受控產品結構與精簡編輯重構 | `.ai-doc/dev_task.md` (`DEV-104 / DEV-PDM-BOM-WORKBENCH-V2-001`)；current RD implementation authority=`.ai-doc/specs/SPEC-BOM-WORKBENCH-001-bom-workbench.md` §18；DEV-071 preserved data／interaction boundary=`.ai-doc/specs/SPEC-BOM-VISUAL-EDITOR-001-xmind-style-bom-editor.md`；domain authority=`.ai-doc/specs/SPEC-PDM-ASSEMBLY-BOM-REBUILD-001-contextual-shared-structure.md`。Status: `RD Implementation Ready / Human Confirmed 01A-02A-03A-04B-05A-06A / Local RD Eligible / RD Not Started / Production Release Gated`。Outliner為desktop唯一可寫editor；Map只讀瀏覽／選取／定位，Floating Topic為收合advanced Draft staging；tablet／phone只讀／審核／匯出。104-A～D內部分期、aggregate QA/QC後一次切換；parity後同DEV移除legacy ReactFlow／XMind presentation，不建V3 route或可寫fallback。Exact file／command／recovery／retirement／fixture與固定48-case denominator見§18.13～18.18。新增schema／migration／public endpoint／permission／lifecycle／feature flag=0，只有既有flag-off PATCH全面fail closed；DEV-071 Floating／CAS／server gate與DEV-096 domain／review／release authority保留。產品實作尚未開始。 |
