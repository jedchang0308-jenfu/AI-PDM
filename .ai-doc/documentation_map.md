...
> **2026-09-08 DEV-117 continuous v2 authority（現行）**：current owner docs為[DEV-117 SPEC §§21～25](specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md)與[QA-DEV-117 forward amendments](qa/qa-dev-117-ai-pdm-independent-production-deployment-validation-plan-2026-09-07.md)，上游是Platform DEV-012 §§25～28（contract SHA-256=`8cfda8b9ce29d5c5f03cd7e240a7adb0c20c51f4a2336d2c6ad3dde3119e838b`；§25～EOF=`f3165d43eb703a67894f279e4026fdc17d416c0f78df4ff874999fce52d4296f`）。狀態=`S1C owner RD Implementation Complete / LOCAL_CONTRACT PASS / DEV-012 S2 Upfront Prerequisites In Progress`。v1六階段dispatch、手貼receipt、run中Product Owner GO與固定觀察期只保留歷史證據；v2採two-capsule、nine-stage machine decision、complete runtime template、immediate abort與own-only rollback。正式provider資源、migration、candidate與traffic仍待S2／S3 native evidence。
>
