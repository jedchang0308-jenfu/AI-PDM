...
> `https://github.com/jedchang0308-jenfu/AI-PDM`的`main`。[DEV-117 §§24～25](specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md)的own native source/runtime/intent producer、Workflows internal OIDC smoke與numeric smoke Secret均已完成本機實作；canonical由shared HTTPS LB提供，legacy Hosting不改指neutral target。Current=`S1C owner RD Implementation Complete / LOCAL_CONTRACT PASS / S2 Upfront Prerequisites In Progress`。
...
> **2026-09-09 DEV-117 continuous v2 authority（現行）**：current owner docs為[DEV-117 SPEC §§21～25](specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md)與[QA-DEV-117 forward amendments](qa/qa-dev-117-ai-pdm-independent-production-deployment-validation-plan-2026-09-07.md)，上游是Platform DEV-012 §§25～28（contract SHA-256=`a1bff69cc3f54775fb193c6fb0ba2d2ce6a89e89f7e4aa4edc0433c6780211c1`；§25～EOF=`52eca43d8e09505ae8ca9f9c90b1fa9286143898b738825ea5485b589acae5b2`）。狀態=`S1C owner RD Implementation Complete / LOCAL_CONTRACT PASS / DEV-012 S2 Upfront Prerequisites In Progress`。v1六階段dispatch、手貼receipt、run中Product Owner GO與固定觀察期只保留歷史證據；v2採two-capsule、nine-stage machine decision、complete runtime template、immediate abort與own-only rollback。正式provider資源、migration、candidate與traffic仍待S2／S3 native evidence。
>
...
| Need | Read |
|---|---|
| DEV-117 AI_PDM 獨立正式部署 adapter | `.ai-doc/dev_task.md` (`DEV-117 / DEV-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001`)；SPEC `.ai-doc/specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md`；QA `.ai-doc/qa/qa-dev-117-ai-pdm-independent-production-deployment-validation-plan-2026-09-07.md`；registry `.ai-doc/qa/dev-117-current-case-registry.json`；profile `config/release/dev117-ai-pdm-independent-production.json`；workflow `.github/workflows/deploy-ai-pdm-independent-production.yml`；Platform對稱authority `../../Jenfu-Platform/ai-doc/specs/DEV-011-independent-platform-production-deployment-contract.md`。Status: `117-S1 Local Implementation Complete / Human Confirmed / QA-QC 12 of 12 PASS / Provider NOT_RUN / Production Release Gated`。Current preflight因非clean main為`INVALIDATED / BLOCKED`；正式release需clean main source lock、billing、DEV-010 shared provider receipts、neutral candidate、DEV-116 R02、canonical evidence與獨立GO。 |
