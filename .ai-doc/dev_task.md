...
> **2026-09-26 DEV-121 目前進度更正**：AI-PDM PR #72 已合併至受保護 main `0c63c218cc1af02c0bb79003d410e80975930524`，immutable inventory image `sha256:75c84584c0c35a87c3fea0b7d09ed9b840cf0e6f1f3bb6fe8857ec363da2bf47` 已完成 owner build／provider digest readback，尚未以新 image 執行 Production Job。較早的 migration-only R2 receipt 已對含 065／066／067 的 source 回報 PASS；OrgMaster v4 consumer 唯讀 readback 亦已 PASS，故下方「尚未發布 v4／尚未 protected merge」均為歷史 checkpoint，不能重跑或當成目前阻礙。現行阻礙是既有 PDM profile 的舊 Firebase UID 未必等於新 managed Google 登入的 canonical pair；逐人確認前不得假造 alias 或切換權限。朱宇鴻與張祐豪待確認 Employee／個人主帳號及角色；蕭旋吟的共用 `info@` profile 暫不設定，待其個人帳號。受控 profile 承接契約與剩餘完成條件見 [DEV-121](specs/DEV-121-target-authorization-boundary.md)。
