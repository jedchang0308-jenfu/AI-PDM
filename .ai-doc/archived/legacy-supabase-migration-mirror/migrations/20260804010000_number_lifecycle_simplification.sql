...
-- Source SHA-256: 04190e5e5fba290c9fad37e93f6c12cb619b31389f01912f8f0301a9d16f6f48
...
ALTER TABLE public.numbering_candidate_revision_drafts ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.numbering_candidate_revision_drafts FORCE ROW LEVEL SECURITY;
ALTER TABLE public.numbering_candidate_revision_files ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.numbering_candidate_revision_files FORCE ROW LEVEL SECURITY;
ALTER TABLE public.drawing_revision_package_review_approvals ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.drawing_revision_package_review_approvals FORCE ROW LEVEL SECURITY;
