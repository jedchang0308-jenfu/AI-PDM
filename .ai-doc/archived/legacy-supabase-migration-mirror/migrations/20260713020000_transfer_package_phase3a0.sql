-- Add transfer package Phase 3A-0 draft workbench tables and controls
-- Source: db/postgres/010_transfer_package_phase3a0.sql
-- Source SHA-256: 437319980699243de8e1ad0ce421ddd4486a556750d9b1b9eff80b9522162ce5
...
ALTER TABLE transfer_package_counters ENABLE ROW LEVEL SECURITY;
ALTER TABLE transfer_package_counters FORCE ROW LEVEL SECURITY;
ALTER TABLE transfer_packages ENABLE ROW LEVEL SECURITY;
ALTER TABLE transfer_packages FORCE ROW LEVEL SECURITY;
ALTER TABLE transfer_package_items ENABLE ROW LEVEL SECURITY;
ALTER TABLE transfer_package_items FORCE ROW LEVEL SECURITY;
ALTER TABLE transfer_package_events ENABLE ROW LEVEL SECURITY;
ALTER TABLE transfer_package_events FORCE ROW LEVEL SECURITY;
