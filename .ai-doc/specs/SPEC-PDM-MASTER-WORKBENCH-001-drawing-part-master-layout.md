...
將「圖料查詢」、「圖號管理」、「料號模組」三個相鄰入口整理成一致的 PDM 主資料工作台版型。
...
- 「圖料查詢」、「圖號管理」、「料號模組」都屬於 PDM 主資料入口，但畫面節奏不一致。
...
| 頁面 | 總表 | 右側明細 |
|---|---|---|
| 圖料查詢 | 跨主根號、料號、圖號的追溯總表 | 主根號明細、關聯圖號/料號、提醒、audit、MA 影響 |
| 圖號管理 | 圖號總表 | 圖號治理資訊、關聯料號、追溯、MA 影響入口 |
| 料號模組 | 料號總表 | 料號屬性、關聯圖號、變體、成本資訊 |
