...
- 圖料工作台明細需將 Draft / Active / PendingReview / Released / Obsolete 等狀態翻譯成可執行下一步，而不只是 badge。
...
- 首頁工作台新增 RD 草稿追蹤區塊。
- 圖號待辦新增待送審草稿區塊。
- 圖料工作台 drawer 在主根明細上方顯示物件級 lifecycle panel。
...
- 開啟圖料工作台 drawer，確認 Draft / Active / Released 等狀態有使用者語言與 CTA。
