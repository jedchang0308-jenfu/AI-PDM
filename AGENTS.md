...
- `CONTINUOUS_NO_DWELL_V2` is governed by `.ai-doc/specs/SPEC-PDM-INDEPENDENT-PRODUCTION-DEPLOYMENT-001-app-owned-release-adapter.md` §§21–22 and its QA forward amendments, bound to Platform DEV-012 contract SHA-256 `47eb972c48549da73ca135509e99bdc8ae4463e87b81785abe8d6cfd8f54b95f`. The six-stage/manual-GO workflow is historical v1 evidence and must not be used as the v2 execution contract. The current owner implementation is S1B-20 Local Contract PASS / S2 Gated, not deployed.
