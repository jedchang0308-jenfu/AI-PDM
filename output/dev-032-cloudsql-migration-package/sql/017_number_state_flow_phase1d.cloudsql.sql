-- DEV-046 Cloud SQL candidate generated from db/postgres/017_number_state_flow_phase1d.sql
...
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:168
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:169
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:170
REVOKE ALL ON transfer_package_draft_items FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:171
REVOKE ALL ON FUNCTION public.reject_transfer_package_event_mutation() FROM PUBLIC;

-- CLOUDSQL_REMOVED_TRANSACTION_WRAPPER_SOURCE_LINE:173
