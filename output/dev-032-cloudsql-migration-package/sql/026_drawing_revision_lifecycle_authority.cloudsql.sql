-- DEV-046 Cloud SQL candidate generated from db/postgres/026_drawing_revision_lifecycle_authority.sql
...
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:125
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:126
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:127
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:128
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:129
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:130
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:131
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:132

-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:134
REVOKE ALL ON TABLE public.drawing_revision_package_part_scopes FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:135
REVOKE ALL ON TABLE public.drawing_revision_lifecycle_workflows FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:136
REVOKE ALL ON TABLE public.drawing_revision_lifecycle_reviewers FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:137
REVOKE ALL ON TABLE public.drawing_revision_lifecycle_command_tokens FROM PUBLIC;
...
-- CLOUDSQL_REMOVED_TRANSACTION_WRAPPER_SOURCE_LINE:237
