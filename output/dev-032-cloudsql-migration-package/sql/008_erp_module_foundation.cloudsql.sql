-- DEV-046 Cloud SQL candidate generated from db/postgres/008_erp_module_foundation.sql
...
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:99
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:100
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:101
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:102

-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:104
REVOKE ALL ON TABLE public.platform_principal_mappings FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:105
REVOKE ALL ON TABLE public.platform_organization_mappings FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:106
REVOKE ALL ON TABLE public.platform_command_receipts FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:107
REVOKE ALL ON TABLE public.platform_outbox_events FROM PUBLIC;
...
-- CLOUDSQL_REMOVED_TRANSACTION_WRAPPER_SOURCE_LINE:118
