-- DEV-046 Cloud SQL candidate generated from db/postgres/016_number_state_flow_phase1c.sql
...
-- CLOUDSQL_REMOVED_TRANSACTION_WRAPPER_SOURCE_LINE:3
...
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:147
-- CLOUDSQL_REMOVED_RLS_SOURCE_LINE:148

-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:150
REVOKE ALL ON TABLE public.numbering_publication_evidence FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:151
REVOKE ALL ON FUNCTION public.reject_approval_platform_target_mutation() FROM PUBLIC;
-- CLOUDSQL_REWROTE_SUPABASE_ROLE_SOURCE_LINE:152
REVOKE ALL ON FUNCTION public.reject_approval_platform_snapshot_mutation() FROM PUBLIC;
...
-- CLOUDSQL_REMOVED_TRANSACTION_WRAPPER_SOURCE_LINE:157
