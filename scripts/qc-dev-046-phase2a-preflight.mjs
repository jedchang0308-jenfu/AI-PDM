...
record("DEV046-2A-016 privacy acknowledgement runtime is retired without deleting immutable historical schema", !report.blockers.some((item) => item.startsWith("NAMED_OWNER_MISSING:")) && !("privacyNoticeApproved" in manifest.approvals) && !report.blockers.includes("PRIVACY_NOTICE_RUNTIME_RETIREMENT_INCOMPLETE") && report.blockers.includes("STAGING_PRINCIPAL_MAPPING_EVIDENCE_MISSING") && report.blockers.includes("STAGING_APPLICATION_ARTIFACT_PROVENANCE_AND_DRIFT_EVIDENCE_MISSING"));
