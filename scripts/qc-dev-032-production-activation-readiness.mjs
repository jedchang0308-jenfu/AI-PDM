...
record("DEV032-ACT-READY-007 Level 3 evidence is exact and current", level3.passed >= 14 && level3.failed === 0 && level3.revision === "ai-pdm-prod-00010-quc" && level3.manifestDigest === "sha256:5a58aa18d88610abfde5e1813e92c7230e223a4fa89e3a8e8f7ade8682c48fef" && level3.runtimeDigest === "sha256:5a58aa18d88610abfde5e1813e92c7230e223a4fa89e3a8e8f7ade8682c48fef");
...
record("DEV032-ACT-READY-010 next action is Wave 0 closure only", report?.nextRequiredAction?.includes("3-5 explicitly named Wave 0 users") && report.nextRequiredAction.includes("product-owner go/no-go") && !/terraform\s+apply|Google account chooser/iu.test(report.nextRequiredAction));
