...
record("DEV032-GATE-015 historical source-boundary evidence remains explicit and non-authorizing", /pm-dev-032-source-boundary-classification-2026-07-15\.md/u.test(preflight) && /dirty paths are classified/u.test(preflight) && sourceBoundary.includes("not releaseable") && sourceBoundary.includes("Production action: none"));
