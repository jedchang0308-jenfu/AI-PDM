...
expect("canonical response schema", contract.includes('schemaVersion: "pdm-entity-detail.v1"'));
...
expect("review action authority", drawer.includes("/api/approvals/requests/") && drawer.includes("Idempotency-Key"));
