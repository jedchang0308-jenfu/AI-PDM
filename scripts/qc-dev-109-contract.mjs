...
check("QA-109-003", "candidate response has mode and reason contract", /mode: "suggested" \| "search" \| "exact"/u.test(context) && /controlled_assembly_file/u.test(context) && /reason:/u.test(component));
