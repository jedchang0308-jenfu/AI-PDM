...
const checks = [
  ...
  ["drawer explicitly says no review", "src/components/canonical-pdm-workbench.tsx", /不需審核/],
  ["drawer requires explicit matrix edit mode", "src/components/canonical-pdm-workbench.tsx", /編輯關聯/],
