...
import { findLatestReport, readReport, validateReport } from "./document-manager-report-utils.mjs";
...
if (!reportPath) {
  console.log(JSON.stringify({
    ...
    reportPath: null,
    issues: [{ type: "missing_report", message: "No Document Manager evidence report found under data/document-manager-reports." }]
  }, null, 2));
