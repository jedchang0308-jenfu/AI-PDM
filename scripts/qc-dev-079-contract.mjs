...
expect("recognition review fields use a compact vertical rhythm and one current PDM commit action", styles.includes(".dev079-recognition-panel { gap: 8px; }") && styles.includes(".dev079-recognition-sections { gap: 7px; }") && styles.includes(".dev079-recognition-candidate { gap: 4px; padding: 6px 0; }") && styles.includes(".dev079-recognition-candidate label input { padding: 6px 8px; }") && recognitionPanel.includes('className="dev079-recognition-save-status"') && recognitionPanel.includes('className="primary-button"') && recognitionPanel.includes('"確認寫入 PDM"') && recognitionPanel.includes('"更新寫入 PDM"') && !recognitionPanel.includes("dev079-recognition-save-all"));
