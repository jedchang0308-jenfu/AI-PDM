...
record("SLICE-011 blocked page renders app-shell blocked state copy", blockedPage.includes("未開放") && blockedPage.includes("/numbering/request") && blockedPage.includes("/numbering/part-drafts"));
...
record("SLICE-014 part-drafts page reads production-slice status", partDraftPage.includes("/api/production-slice/status") && partDraftPage.includes("productionSliceEnforced"));
record("SLICE-015 part-drafts submit-review UI is inert in slice mode", partDraftPage.includes('action === "submit-review"') && partDraftPage.includes('<UnopenedAction label="送審"'));
