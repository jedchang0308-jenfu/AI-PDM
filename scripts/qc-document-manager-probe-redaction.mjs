...
const sampleDir = path.join(root, "data", "qc-fixtures", "document-manager-probe-redaction");
const outputDir = path.join(root, "data", "document-manager-probes", "qc-redaction");
