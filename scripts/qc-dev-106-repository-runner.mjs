...
const base = () => ({
  lines: [{ id: "line-a", logicalLineId: "00000000-0000-4000-8000-000000000001", nodeType: "item", partNumber: "C-A", quantity: 1, sequenceNo: 1 }],
  floatingTopics: [],
...
const cases = [
  ...
  expectCode("duplicate child rejected", { ...base(), lines: [...base().lines, { id: "line-b", logicalLineId: "00000000-0000-4000-8000-000000000002", nodeType: "item", partNumber: "C-A", quantity: 1, sequenceNo: 2 }], components: [...base().components, { nodeId: "line-b", logicalLineId: "00000000-0000-4000-8000-000000000002", nodeLocation: "tree", componentMode: "fixed", childPartNumberIds: [childA], parentSelections: [] }] }, "BOM_SALES_KIT_DUPLICATE_CHILD"),
  expectCode("missing component rejected", { ...base(), components: [] }, "BOM_COMPONENT_REQUIRED"),
  expectCode("zero quantity rejected", { ...base(), lines: [{ ...base().lines[0], quantity: 0 }] }, "BOM_ITEM_QUANTITY_INVALID"),
  expectCode("negative quantity rejected", { ...base(), lines: [{ ...base().lines[0], quantity: -1 }] }, "BOM_ITEM_QUANTITY_INVALID"),
