...
record("DEV032-COMMIT-PLAN-008 included pathspec matches plan mode", plan?.releaseDecision?.exactReleaseCommitExists === true ? included.length === 0 : ["src/", ".ai-doc/", "scripts/", "db/", "package.json"].every((prefix) => included.some((item) => item === prefix || item.startsWith(prefix))));
