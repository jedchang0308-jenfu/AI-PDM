...
- DEV-095 BOM retirement is migration `047_remove_bom_module.sql`; it permanently deletes the retired module tables and compatibility actions. Production execution requires a verified Cloud SQL backup and the dedicated live-migration approval gate.
